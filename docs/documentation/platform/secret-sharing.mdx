...
<AccordionGroup>
	...
	<Accordion title="How long can a shared secret last?">
		Up to 30 days. Your organization can set a shorter maximum lifetime, in which
		case that limit applies to everyone in the organization.
	</Accordion>
	<Accordion title="How large a secret can I share?">
		Up to 10,000 characters.
	</Accordion>
	<Accordion title="Can I stop a link from working after I have sent it?">
		Yes. Delete the shared secret from the Secret Sharing page and the link stops
		working for anyone who has not opened it yet.
	</Accordion>
</AccordionGroup>
