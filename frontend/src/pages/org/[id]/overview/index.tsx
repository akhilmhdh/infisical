        ...
        <div className="mb-4 flex flex-col items-start justify-start px-6 py-6 pb-0 text-3xl">
          ...
          >
            ...
            <div className="text-sm">
              <span className="text-lg font-semibold">Scheduled maintenance on January 20th</span>{" "}
              <br />
              We&apos;ve planned a database upgrade and need to pause certain functionality for
              approximately 6 hours on Saturday, January 20th, 10am EST. Read operations will
              continue to function as normal but nothing will be editable. As a user you don&apos;t
              have to perform any action – your applications will not be affected.
              <br />
            </div>
            <button
              type="button"
