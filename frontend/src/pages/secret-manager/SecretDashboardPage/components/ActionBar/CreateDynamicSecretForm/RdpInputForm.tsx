  ...
  const handleCreateDynamicSecret = async ({
    ...
    try {
      await createDynamicSecret.mutateAsync({
        provider: { type: DynamicSecretProviders.Rdp, inputs: provider },
        maxTTL,
        name,
        path: secretPath,
        defaultTTL,
            ...
            <div className="flex-grow">
              <Controller
                ...
                render={({ field, fieldState: { error } }) => (
                  ...
                  >
                    <Input {...field} placeholder="dynamic-rdp" />
                  </FormControl>
                )}
              />
            </div>
                ...
                <Controller
                  ...
                  render={({ field, fieldState: { error } }) => (
                    <FormControl
                      ...
                      errorText={error?.message}
                    >
                      <Input {...field} placeholder="ip address or domain" />
                    </FormControl>
                  )}
                />
                <Controller
